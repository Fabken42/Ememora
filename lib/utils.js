...
export const TERM_PAGE_SIZE = 20; // Número de termos por página na visualização de lista
export const LISTS_PAGE_SIZE = 10; // Número de listas por página na página inicial e de usuário
